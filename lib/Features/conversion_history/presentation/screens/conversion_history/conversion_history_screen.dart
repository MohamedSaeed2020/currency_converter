              ...
              children: <Widget>[
                ...
                MediaQuery.removePadding(
                  ...
                  child: ListView.separated(
                    ...
                    itemCount: conversionHistoryCubit.conversionsHistoryDate.length
                    ,
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: CurrencyHistoryItem(
                          ...
                          conversionHistoryCubit.conversionsHistoryDate,
                          conversionHistoryValues: conversionHistoryCubit.conversionsHistoryValues,
                          index: index,
                        ),
                      );
                    },
